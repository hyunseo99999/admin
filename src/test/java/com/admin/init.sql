...
insert into tb_user (user_id, create_at, create_id, password, update_at, update_id, use_yn, username, email, login_id)
values
    ('1', now(), '1', '$2a$10$mZ2HvRc/KkQwKXidN6KzCuBHuoAPMpSj/Pq7.YKK9k7I/h8xulHay', now(), '1', 'Y', '관리자', 'test@test.com', 'admin');
